        ...
        protected void gvAvailableSessions_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Assign")
            {
                ...
                string sql = "Set Identity_Insert Job_Hour_Log ON " +
                    ...
                    "Values (" + Convert.ToInt32(Session["ClientID"]) + " , " + Convert.ToInt32(row.Cells[3].Text) + " , " + Convert.ToInt32(row.Cells[0].Text) + " , '" + Convert.ToDateTime(calBookingDate.SelectedDate).ToString("yyyy-MM-dd") + "' , 'Pending' , 0 )" +
