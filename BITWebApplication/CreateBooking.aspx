<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateBooking.aspx.cs" Inherits="BITWebApplication.CreateBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="row">
        <div class="col-12">
            <asp:GridView CssClass="table table-striped table-bordered" ID="gvAvailableClients" runat="server" AutoGenerateColumns="false" OnRowCommand="gvAvailableClients_RowCommand">
                <Columns>
                    <asp:BoundField HeaderText="Client ID" DataField="Client_ID" />
                    <asp:BoundField HeaderText="First Name" DataField="FirstName" />
                    <asp:BoundField HeaderText="Last Name" DataField="LastName" />
                    <asp:BoundField HeaderText="Business Name" DataField="Business" />
                    <asp:BoundField HeaderText="ABN" DataField="ABN" />
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:Button ID="btnSelect" CausesValidation="false" runat="server" Text="Select" Width="80px" Height="40px" CommandName="Select" CommandArgument="<%# Container.DataItemIndex %>"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <asp:TextBox CssClass="form-control" ID="txtClientID" runat="server" Enabled="false"/>
                    <asp:RequiredFieldValidator ID="rfvClient" runat="server" ControlToValidate="txtClientID" ErrorMessage="Please Select a Client" style="color:red;"/>
                </div>
            </div>
        </div>
    </div>
